...
const Home = () => {
  return (
    <>
    <section className=" bg-transparent flex justify-center items-center pt-24 lg:pt-5"style={{}} id='home'>
    <div className=" flex flex-col lg:flex-row justify-center  items-center w-full" style={{}}>
    <motion.div initial={{ opacity: 0, x:100 }}
    animate={{ opacity: 1, x:0 }}
    transition={{ duration: 1 }} className="flex justify-center items-center w-full lg:hidden lg:mt-0 sm:col-span-1 lg:col-span-5" >
  ...
  transition={{ repeat: Infinity, repeatType:"reverse", duration: 4 }}  className="heroimg h-auto self-center" src="/varad.png" alt="mockup" />
    ...
    transition={{ duration: 1 }} className=" w-full md:w-2/3 place-self-center sm:col-span-1 lg:col-span-7" style={{}}>
            ...
            <h1 className=" text-center mb-4 lg:text-4xl text-2xl font-extrabold leading-none md:text-4xl xl:text-4xl dark:text-white" style={{letterSpacing:1}}>Varad Prabhu</h1>
            <p className=" text-center mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-300" style={{}}>second year undergrad student pursuing computer engineering in DJSCE </p>
            </div>
            <div className='justify-center grid grid-flow-row-dense sm:gird-cols-1 sm:grid-rows-3 lg:grid-cols-2 lg:grid-rows-2 '>
            <a href="/varad_resume.pdf" download="Varad's Resume" style={{margin:20}} className="trans sm:col-span-1 sm:row-span-1 inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 rounded-lg bg-black focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-black dark:focus:ring-gray-800">
                Get Resume
            </a>
             <a href="https://github.com/vaxad?tab=repositories" target="_blank" className=" scale sm:col-span-1 sm:row-span-1 inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center">
                View Repositories
