...
const PhoneCard = ({web, repo, title, desc, img1, img2, img3}) => {
  return (
    ...
    <div className='proj rounded-2xl flex flex-col lg:flex-row justify-center items-center gap-4'>
      ...
      <button type="button" className=" card smbtn text-white lg:my-0 sm:my-2  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover: dark:focus:ring-blue-800">View Prototype</button>
      </a>
