...
export default function AchievementCard({title, company, date, location, skills, url, img}) {
  ...
  return (
    ...
    <div className='proj rounded-2xl flex w-full flex-col lg:flex-row flex-wrap lg:flex-nowrap justify-center items-center gap-4' >
      ...
      <button type="button" className=" card smbtn text-white lg:my-0 sm:my-2  hover:bg-blue-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 bg-blue-600 hover: focus:ring-blue-800">View Company</button>
      </a>
