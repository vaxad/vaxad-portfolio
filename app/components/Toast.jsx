...
export default function Toast({error,text,setToast,toast}) {
  return (
    <div className={`py-2 scale-90 hover:scale-105 cursor-pointer hover:bg-opacity-90 underline decoration-black md:scale-100 px-4 ${toast?"translate-x-0 delay-0 duration-300":"translate-x-[200%] delay-100 duration-700"} transition-all  flex flex-row gap-5 items-center justify-between w-fit min-w-[30vw] bg-slate-100 bg-opacity-80 rounded-lg fixed z-50 top-20 right-0 md:right-16`}>
        <a href="https://vaxad.vercel.app"  className=' flex flex-row justify-start items-center gap-2'>
        {error?
